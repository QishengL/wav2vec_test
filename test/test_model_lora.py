...
# 加载模型和processor
model_path = "/mnt/storage/qisheng/github/wav2vec_test/weights/ru_18000-xlsr-300m/checkpoint-60000"
...
model = MyWav2Vec2ForCTC.from_pretrained(model_path)
tokenizer = AutoTokenizer.from_pretrained(model_path,phonemizer_lang='uk')
...
#adapter_path = "/mnt/storage/qisheng/github/wav2vec_test/weights/lora/ru2uk-xlsr-300m-3e4/checkpoint-6300"
