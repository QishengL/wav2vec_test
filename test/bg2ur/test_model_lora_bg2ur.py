...
# 加载模型和processor
model_path = "/mnt/storage/qisheng/github/wav2vec_test/weights/bg_9000-xlsr-300m_notgeneral/checkpoint-20000"
model = MyWav2Vec2ForCTC.from_pretrained(model_path)
adapter_path = "/mnt/storage/qisheng/github/wav2vec_test/weights/lora/bg2ur_100-xlsr-300m_nogeneral/checkpoint-14000"
tokenizer = AutoTokenizer.from_pretrained(adapter_path,phonemizer_lang='ur')
...
for i in range(10):
    ...
    additional_kwargs = {}
    additional_kwargs["phonemizer_lang"] = 'ur'
