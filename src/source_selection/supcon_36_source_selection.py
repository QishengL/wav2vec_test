"""
SupCon (original) Source Selection with all 36 languages.
"""
...
RESULTS_PATH = "/mnt/storage/qisheng/github/wav2vec_test/results/ablation/contrastive_36_results.json"
...
def main():
    print("=" * 70)
    print("SUPCON SOURCE SELECTION (36 candidates)")
    print("=" * 70)
