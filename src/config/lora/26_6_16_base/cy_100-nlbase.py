...
wandb_run = "cy_100-nlbase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/cy_100-xlsr-nlbase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/cy_100-xlsr-nlbase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/nl_9000-xlsr-base_general_1e5/checkpoint-26000",
