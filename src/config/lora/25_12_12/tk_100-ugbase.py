...
wandb_run = "tk_100-ugbase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/tk_100-xlsr-ugbase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/tk_100-xlsr-ugbase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/ug_9000-xlsr-base_general_1e5/checkpoint-6000",
