...
wandb_run = "kk_100-babase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/kk_100-xlsr-babase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/kk_100-xlsr-babase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/ba_9000-xlsr-base_general_1e5/checkpoint-28000",
