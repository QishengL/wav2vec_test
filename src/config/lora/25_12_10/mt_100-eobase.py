...
wandb_run = "mt_100-eobase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/mt_100-xlsr-eobase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/mt_100-xlsr-eobase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/eo_9000-xlsr-base_general_1e5/checkpoint-28000",
