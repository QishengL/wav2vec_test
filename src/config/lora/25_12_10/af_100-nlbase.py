# config_base.py
#create_vocab = True
wandb_project = "wav2vec_12_10"
wandb_run = "af_100-nlbase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/af_100-xlsr-nlbase", 
    "overwrite_output_dir":True,        
    "num_train_epochs": 1800,                                    
    ...
    "eval_strategy":"steps",
    "eval_steps":800,                 # 每 1000 步评估一次
    "logging_steps":10, 
                             
}
MODEL_PARAMS = {
    "output_dir": "../weights/af_100-xlsr-nlbase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/nl_9000-xlsr-base_general_1e5/checkpoint-28000",
