...
wandb_run = "sk_100-csbase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/sk_100-xlsr-csbase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/sk_100-xlsr-csbase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/cs_9000-xlsr-base_general_1e5/checkpoint-28000",
