...
wandb_run = "mt_100-debase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/mt_100-xlsr-debase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/mt_100-xlsr-debase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/de_9000-xlsr-base_general_1e5/checkpoint-28000",
