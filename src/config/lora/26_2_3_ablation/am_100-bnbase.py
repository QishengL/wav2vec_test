...
wandb_run = "am_100-bnbase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/am_100-xlsr-bnbase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/am_100-xlsr-bnbase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/bn_9000-xlsr-base_general_1e5/checkpoint-28000",
