...
wandb_run = "sk_100-ukbase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/sk_100-xlsr-ukbase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/sk_100-xlsr-ukbase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/uk_9000-xlsr-base_general_1e5/checkpoint-28000",
