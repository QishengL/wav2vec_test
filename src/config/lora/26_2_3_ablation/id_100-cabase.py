...
wandb_run = "id_100-cabase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/id_100-xlsr-cabase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/id_100-xlsr-cabase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/ca_9000-xlsr-base_general_1e5/checkpoint-28000",
