...
wandb_run = "af_100-cybase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/af_100-xlsr-cybase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/af_100-xlsr-cybase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/cy_9000-xlsr-base_general_1e5/checkpoint-28000",
