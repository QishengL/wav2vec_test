...
wandb_run = "mt_100-ttbase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/mt_100-xlsr-ttbase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/mt_100-xlsr-ttbase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/tt_9000-xlsr-base_general_1e5/checkpoint-28000",
