...
wandb_run = "ko2uk_100v2"
checkpoint = "/mnt/storage/qisheng/github/wav2vec_test/weights/ko_9000-xlsr-300m/checkpoint-2300"
new_vocab_path = "/mnt/storage/qisheng/github/wav2vec_test/vocab_builder/vocab_folder/cv_uk_phoneme"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/lora/ko2uk_100-xlsr-300m", 
