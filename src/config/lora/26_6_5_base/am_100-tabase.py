...
wandb_run = "am_100-tabase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/am_100-xlsr-tabase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/am_100-xlsr-tabase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/ta_9000-xlsr-base_general_1e5/checkpoint-26000",
