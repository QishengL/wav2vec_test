...
wandb_run = "cy_100-swbase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/cy_100-xlsr-swbase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/cy_100-xlsr-swbase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/sw_9000-xlsr-base_general_1e5/checkpoint-26000",
