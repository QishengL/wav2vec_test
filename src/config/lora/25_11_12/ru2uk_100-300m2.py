...
#create_vocab = True
reinit = True
wandb_project = "wav2vec_300m_lora_11_12"
wandb_run = "ru2uk_100v2"
checkpoint = "/mnt/storage/qisheng/github/wav2vec_test/weights/ru_9000-xlsr-300m/checkpoint-56000"
new_vocab_path = "/mnt/storage/qisheng/github/wav2vec_test/vocab_builder/vocab_folder/cv_uk_phoneme"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/lora/ru2uk_100-xlsr-300m_11_12", 
