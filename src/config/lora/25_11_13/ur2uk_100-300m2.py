...
checkpoint = "/mnt/storage/qisheng/github/wav2vec_test/weights/ur_9000-xlsr-300m_general/checkpoint-7000"
new_vocab_path = "/mnt/storage/qisheng/github/wav2vec_test/vocab_builder/vocab_folder/cv_uk_phoneme"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/lora/ur2uk_100-xlsr-300m_general", 
