...
wandb_run = "be2uk_100v2"
checkpoint = "/mnt/storage/qisheng/github/wav2vec_test/weights/be_9000-xlsr-300m_general2/checkpoint-2500"
new_vocab_path = "/mnt/storage/qisheng/github/wav2vec_test/vocab_builder/vocab_folder/cv_uk_phoneme"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/lora/be2uk_100-xlsr-300m_general", 
