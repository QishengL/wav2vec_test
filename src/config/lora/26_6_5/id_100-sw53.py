...
wandb_run = "id_100-sw53"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/id_100-xlsr-sw53", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/id_100-xlsr-sw53", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/sw_9000-xlsr-53_general_1e5/checkpoint-28000",
