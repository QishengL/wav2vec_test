...
wandb_run = "es2el_100v2"
checkpoint = "/mnt/storage/qisheng/github/wav2vec_test/weights/es_9000-xlsr-300m_general/checkpoint-2500"
new_vocab_path = "/mnt/storage/qisheng/github/wav2vec_test/vocab_builder/vocab_folder/cv_el_phoneme"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/lora/es2el_100-xlsr-300m_general", 
