...
wandb_run = "tk_100-multiug+ba+tt"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/tk_100-xlsr-multiug+ba+tt", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/tk_100-xlsr-multiug+ba+tt", 
    "model_name_or_path" : "../weights/multi_ug+ba+tt-xlsr-53/LAST_CHECKPOINT",
...
DATASET_PARAMS = {
    ...
    "max_eval_samples_per_language":[337],
