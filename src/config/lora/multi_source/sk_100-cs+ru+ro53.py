...
wandb_run = "sk_100-cs+ru+ro53"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/sk_100-xlsr-cs+ru+ro53", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/sk_100-xlsr-cs+ru+ro53", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/multi_cs+ru+ro-xlsr-53/checkpoint-28150",
