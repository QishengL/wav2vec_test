# config_53.py
wandb_project = "wav2vec_multi_source_s2"
wandb_run = "ltg_100-multilv+ru+lt"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/ltg_100-xlsr-multilv+ru+lt", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/ltg_100-xlsr-multilv+ru+lt", 
    "model_name_or_path" : "../weights/multi_lv+ru+lt-xlsr-53/LAST_CHECKPOINT",
