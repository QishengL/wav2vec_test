...
wandb_run = "ur_100-ta+tr+ro53"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/ur_100-xlsr-ta+tr+ro53", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/ur_100-xlsr-ta+tr+ro53", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/multi_ta+tr+ro-xlsr-53/checkpoint-28150",
