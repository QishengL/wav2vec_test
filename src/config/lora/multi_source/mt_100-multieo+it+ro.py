...
wandb_run = "mt_100-multieo+it+ro"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/mt_100-xlsr-multieo+it+ro", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/mt_100-xlsr-multieo+it+ro", 
    "model_name_or_path" : "../weights/multi_eo+it+ro-xlsr-53/LAST_CHECKPOINT",
...
DATASET_PARAMS = {
    ...
    "max_eval_samples_per_language":[514],
