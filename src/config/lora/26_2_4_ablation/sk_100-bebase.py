...
wandb_run = "sk_100-bebase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/sk_100-xlsr-bebase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/sk_100-xlsr-bebase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/be_9000-xlsr-base_general_1e5/checkpoint-28000",
