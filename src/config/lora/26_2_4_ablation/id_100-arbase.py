...
wandb_run = "id_100-arbase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/id_100-xlsr-arbase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/id_100-xlsr-arbase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/ar_9000-xlsr-base_general_1e5/checkpoint-28000",
