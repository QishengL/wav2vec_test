...
wandb_run = "mt_100-itbase"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/mt_100-xlsr-itbase", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/mt_100-xlsr-itbase", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/it_9000-xlsr-base_general_1e5/checkpoint-28000",
