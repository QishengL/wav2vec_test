...
wandb_run = "uk_100-be300m"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {
    "output_dir": "../weights/uk_100-xlsr-be300m", 
...
MODEL_PARAMS = {
    "output_dir": "../weights/uk_100-xlsr-be300m", 
    "model_name_or_path" : "/mnt/storage/qisheng/github/wav2vec_test/weights/be_9000-xlsr-300m_general2/checkpoint-2500",
