"""Patch missing am_base configs."""
import os
BASE = "/mnt/storage/qisheng/github/wav2vec_test"

for src in ['ar','ba','ca','eo','hu','it','sw','ta']:
    ...
    content = f"""# config_base.py
wandb_project = "wav2vec_26_6_5"
wandb_run = "am_100-{src}base"
preprocessing_only = False
resume = False
TRAINING_PARAMS = {{
    "output_dir": "../weights/am_100-xlsr-{src}base", 
...
"""
    fname = os.path.join(BASE, 'src', 'config', 'lora', '26_6_5_base', f"am_100-{src}base.py")
    with open(fname, 'w') as f:
        f.write(content)
    print(f"Created: am_100-{src}base.py")
